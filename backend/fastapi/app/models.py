...
class AqcWorkOrder(Base):
    ...
    deleted_by_id: Mapped[int | None] = mapped_column(ForeignKey("aqc_users.id", ondelete="SET NULL"), nullable=True, index=True)
    deleted_by_name: Mapped[str] = mapped_column(String(80), default="", server_default="")
    ...
    deleted_by_user: Mapped[AqcUser | None] = relationship(foreign_keys=[deleted_by_id])
